//
// EventModule.cpp for bomberman in /home/saenen_a/Work/Rendu/Application_test
// 
// Made by Alexander Saenen
// Login   <saenen_a@epitech.net>
// 
// Started on  Tue May  5 13:10:18 2015 Alexander Saenen
// Last update Tue May  5 17:15:03 2015 Alexander Saenen
//
...
EventModule *EventModule::handle()
{
  ...
  while (!this->_events.empty())
    {
      ...
      std::cout << "\t\tGoing to handle: propagating=" << ev->propagate() << " emptyHandlers=" << handlers.empty() << std::endl;
  ...
  std::cout << "Finished handling" << std::endl;
  return (this);
}
